...
return [
	...
	*/
	...
	'routes' => function(ExtensionInterface $extension, Application $app)
	{
		Route::group([
            'prefix'    => 'thumb',
            'namespace' => 'Sanatorium\Thumbs\Controllers\Frontend',
        ], function () {
            Route::get('view/{path}', ['as' => 'thumb.view', 'uses' => 'ThumbsController@view'])->where('path', '.*?');
        });
	},
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			/*[
				'slug'  => 'admin-sanatorium-thumbs',
				'name'  => 'Thumbs',
				'class' => 'fa fa-circle-o',
				'uri'   => 'thumbs',
				'regex' => '/:admin\/thumbs/i',
			],*/
